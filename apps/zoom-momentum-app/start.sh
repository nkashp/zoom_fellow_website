...
echo "=== Starting ngrok ==="
ngrok http 3001 --url=agilely-gabelled-clementine.ngrok-free.dev > /tmp/ngrok.log 2>&1 &
sleep 4
if lsof -ti:4040 > /dev/null 2>&1; then
  echo "  ngrok running at https://agilely-gabelled-clementine.ngrok-free.dev"
else
...
echo "  ngrok:   https://agilely-gabelled-clementine.ngrok-free.dev"
